		...
		<div class="container_12 main">
			...
			<article class="clearfix">
				<section class="clearfix">
					...
					<p class="info-message"><a href="https://github.com/caio-ribeiro-pereira/SimulaRSO" target="_blank"><strong><fmt:message key="sobre.codigo.fonte" /></strong></a></p>
					<hr>
					<h3 class="clearfix subtitle"><fmt:message key="sobre.funcionalidade.titulo" /></h3>
					<ul>
						<li><small class="checked" title="Funcionalidade liberada."><fmt:message key="sobre.funcionalidade.msg1" /></small></li>
						<li><small class="checked" title="Funcionalidade liberada."><fmt:message key="sobre.funcionalidade.msg2" /></small></li>
						<li><small class="checked" title="Funcionalidade liberada."><fmt:message key="sobre.funcionalidade.msg3" /></small></li>
						<li><small class="checked" title="Funcionalidade liberada."><fmt:message key="sobre.funcionalidade.msg4" /></small></li>
						<li><small class="checked" title="Funcionalidade liberada."><fmt:message key="sobre.funcionalidade.msg5" /></small></li>
						<li><small class="checked" title="Funcionalidade liberada."><fmt:message key="sobre.funcionalidade.msg6" /></small></li>
					</ul>
					<hr>
					...
					<ul>
						...
						<li><small style="margin-left: 30px;"><a href="http://vraptor.caelum.com.br" target="_blank"><strong>VRaptor 3.3.1</strong></a> - <fmt:message key="sobre.tecnologias.vraptor" /></small></li>
						...
						<li><small style="margin-left: 30px;"><a href="http://www.w3schools.com/html5/default.asp" target="_blank"><strong>HTML 5</strong></a> - <fmt:message key="sobre.tecnologias.html5" /></small></li>
						<li><small style="margin-left: 30px;"><a href="http://www.w3schools.com/css3/default.asp" target="_blank"><strong>CSS 3</strong></a> - <fmt:message key="sobre.tecnologias.css3" /></small></li>
