			...
			<article class="clearfix">
				<section class="clearfix">
					...
					<ul>
						...
						<li><small title="Funcionalidade em desenvolvimento.">Simular os principais algoritmos de substituição de página de memória virtual com até 40 palavras de bytes na escrita.</small></li>
					...
					<ul>
						...
						<li><small><a href="http://code.google.com/appengine/" target="_blank"><strong>Google App Engine</strong></a> - Serviço de hospedagem em Cloud Computing para aplicações Java e Python.</small></li>
						...
						<li><small><a href="http://jstl.java.net" target="_blank"><strong>JSTL 1.2</strong></a> - Tags Java para incorporar funcionalidades em uma página JSP.</small></li>
						...
						<li><small><a href="http://jquery.com/" target="_blank"><strong>JQuery 1.5.1</strong></a> - Biblioteca Javascript Cross-browser para manipulação de elementos DOM HTML.</small></li>
						<li><small><a href="http://jqueryui.com/" target="_blank"><strong>JQuery-UI 1.8.11</strong></a> - Conjunto de interfaces gráficas prontas e totalmente compatível com JQuery.</small></li>
						<li><small><a href="http://www.jgeppert.com/jquery-spinner/" target="_blank"><strong>JQuery-UI Spinner Plugin 1.24</strong></a> - Plugin JQuery para implementar um spinner control.</small></li>
