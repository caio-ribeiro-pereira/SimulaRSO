...
<body>
	...
	<ul>
		...
		<li><small><a href="http://code.google.com/appengine/" target="_blank"><strong>Google App Engine</strong></a> - Cloud Host para aplicações web open-source Java ou Python.</small></li>
