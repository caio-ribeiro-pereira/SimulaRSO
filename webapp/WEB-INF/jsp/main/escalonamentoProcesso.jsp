		...
		<div id="process-menu" class="clearfix menu">
			<div id="processo-1" class="input-box">
				<p>
					...
					<input type="hidden" name="processos[0].id" value="1">
				</p>
				<p>
					<label class="grid_1" for="burst-1"><small>Burst: </small></label>
					<input type="text" class="grid_1" name="processos[0].burst" id="burst-1" maxlength="2">
				</p>
				<p>
					<label class="grid_1" for="chegada-1"><small>Chegada: </small></label>
					<input type="text" class="grid_1" name="processos[0].chegada" id="chegada-1" maxlength="2">
				</p>
				<p>
					<label class="grid_1" for="prioridade-1"><small>Prioridade: </small></label>
					<input type="text" class="grid_1" name="processos[0].prioridade" id="prioridade-1" maxlength="2">
				</p>
			</div>
			<div id="processo-2" class="input-box">
				<p>
					<small>Processo 2: </small>
					<input type="hidden" name="processos[1].id" value="2">
				</p>
				<p>
					<label class="grid_1" for="burst-2"><small>Burst: </small></label>
					<input type="text" class="grid_1" name="processos[1].burst" id="burst-2" maxlength="2">
				</p>
				<p>
					<label class="grid_1" for="chegada-2"><small>Chegada: </small></label>
					<input type="text" class="grid_1" name="processos[1].chegada" id="chegada-2" maxlength="2">
				</p>
				<p>
					<label class="grid_1" for="prioridade-2"><small>Prioridade: </small></label>
					<input type="text" class="grid_1" name="processos[1].prioridade" id="prioridade-2" maxlength="2">
				</p>
			</div>
